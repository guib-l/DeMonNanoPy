...
class TestWater2:
    ...
    def test_water_1(self):
        ...
        assert np.allclose(modes[1],3804, atol=1.)
        assert np.allclose(modes[0],1562, atol=1.)
        assert np.allclose(modes[2],4078, atol=1.)
    ...
    def test_water_2(self):
        ...
        h2_positions_1 = last.positions[4]
        h2_positions_2 = last.positions[5]
        ...
        assert np.allclose(modes[1],136, atol=1.)
        assert np.allclose(modes[2],153, atol=1.)
        assert np.allclose(modes[3],230, atol=1.)
        assert np.allclose(modes[4],367, atol=1.)
        assert np.allclose(modes[5],553, atol=1.)
        assert np.allclose(modes[6],1560, atol=1.)
        assert np.allclose(modes[7],1582, atol=1.)
        assert np.allclose(modes[8],3667, atol=1.)
        assert np.allclose(modes[9],3800, atol=1.)
        assert np.allclose(modes[10],3993, atol=1.)
        assert np.allclose(modes[11],4070, atol=1.)
