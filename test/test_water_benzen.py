...
class TestWaterBenzen:
    ...
    def test_benzen(self):
        ...
        assert np.allclose(modes[4],657, atol=1.)
    ...
    def test_water_benzen(self):
        ...
        assert np.allclose(modes[32],3012-33, atol=1.)
        assert np.allclose(modes[36],3013+18, atol=1.)
